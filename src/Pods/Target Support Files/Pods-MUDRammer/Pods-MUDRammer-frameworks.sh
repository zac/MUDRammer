...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/IFTTTLaunchImage/IFTTTLaunchImage.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MyLilTimer/MyLilTimer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/OSCache/OSCache.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/QuickDialog/QuickDialog.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SAMRateLimit/SAMRateLimit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SPLCore/SPLCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SPLUserActivity/SPLUserActivity.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SSAccessibility/SSAccessibility.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SSApplication/SSApplication.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SSDataSources/SSDataSources.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SSOperations/SSOperations.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/libtelnet/libtelnet.framework"
